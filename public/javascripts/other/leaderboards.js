...
async function generateLeaderboards() {
    ...
    const loadingElement = createElement("p", { p: leaderboardsContainer, t: LOADING_TEXT })
    loadingElement.style.display = "block"
    loadingElement.style["margin-top"] = "16px"
    loadingElement.style["text-align"] = "center"
    ...
    for (let i = 0; i < leaderboards.length; i++) {
        ...
        const leaderboardView = createElement("div", { p: leaderboardsContainer })
        ...
        const selector = createElement("button", {
            p: leaderboardSelection, t: leaderboardName, onClick: () => {
                ...
                for (let lv of leaderboardsContainer.children) {
                    setVisible(lv, false)
                }
        ...
        dataPromise.then(res => {
            ...
            renderSwallowtail(gold, leaderboardData[0], leaderboardTypeFunction)
            renderSwallowtail(silver, leaderboardData[1], leaderboardTypeFunction)
            renderSwallowtail(bronze, leaderboardData[2], leaderboardTypeFunction)
...
function renderSwallowtail(swalllowtail, data, typeLabel) {
